...
(function (scope) {
    ...
    var _drawShape = function (stroke, context, parameters) { // jshint ignore:line
...
(function (scope) {
    ...
    InkGrabber.prototype.setPenOrErase = function (value) {
        this.penorerase = value;
        if (this.penorerase == 'pen') {
            this.penParameters.setColor('rgba(0, 0, 0, 0.9)');
            this.penParameters.setWidth(3);          
        }
        else {
...
(function (scope) {
     ...
     * @param {PenParameters} parameters
     */
    var _drawChar = function (component, context, parameters) { // jshint ignore:line
        throw new Error('not implemented');
    };
     ...
     * @param {PenParameters} parameters
     */
    var _drawString = function (component, context, parameters) { // jshint ignore:line
...
(function (scope) {
    ...
    function InkPaper(element, options, callback) {
        ...
        this._inkRenderer = new scope.InkRenderer(this._renderingCanvas.getContext('2d'));
    ...
    InkPaper.prototype._clearRESTRecognition = function (instanceId) {
        ...
        if (this._selectedRecognizer != undefined &&
            this._selectedRecognizer instanceof scope.ShapeRecognizer) {
            this.isStarted = false;
            this._lastSentComponentIndex = 0;
    ...
    InkPaper.prototype.undo = function (clear_canvas) {
        if (this.canUndo()) {
            ...
            this.isStarted = false;
            if (this._selectedRecognizer != undefined && 
                this._selectedRecognizer instanceof scope.AbstractWSRecognizer) {
                this._selectedRecognizer.resetWSRecognition();
            } else {
    ...
    InkPaper.prototype.renderAll = function(clear_canvas) {
        if (this._selectedRenderer != null) {
            if (clear_canvas) this._selectedRenderer.clear();
            var pageinfo = this.getPageinfo(this._currentpageNo);
            if (pageinfo == "")
                return;
    ...
    InkPaper.prototype._up = function (x, y, t) {
        ...
        if (stroke.getLength() > 0) {
            ...
            var pageinfo = this.getPageinfo(this._currentpageNo);
            if (pageinfo) pageinfo.push(stroke);
        }
        ...
        else if (shape && !shape.isEmpty())
        {
           if (this._selectedRenderer != undefined) {
            ...
            var pageinfo = this.getPageinfo(this._currentpageNo);
            if (pageinfo) pageinfo.push(shape);
        }
