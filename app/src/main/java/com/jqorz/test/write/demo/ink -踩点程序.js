...
(function (scope) {
    ...
    StrokeComponent.prototype.clear = function () {
        ...
        this.width = 0;
        this.pentype = "mao";  //画笔类型= 铅笔pen,毛笔mao. 橡皮擦erase，准备废弃 penorerase
        this.penorerase = 'pen';
        this.pageid = 0;
    }
...
(function (scope) {
    ...
    function _renderMaoStroke(stroke, context, isDrawAll, inkgrabber) {
        ...
        context.closePath();
        //_fileStroke(context, stroke);//测试代码
    ...
    function _renderPenStroke(stroke, context, isDrawAll, inkgrabber) {
        ...
        context.fillStyle = stroke.getColor();
        ...
        if (length < 3) {
            ...
            if (isDrawAll || !inkgrabber.hasArealyDrawBody) {
                ...
                for (var i = 1; i < length; i++) {
                    ...
                    context.quadraticCurveTo(lastPoint.x, lastPoint.y, cpx1, cpy1);
                }
            } else {//增量绘制
                ...
                context.moveTo((lastlast.x + lastPoint.x) / 2, (lastlast.y + lastPoint.y) / 2);
                context.quadraticCurveTo(lastPoint.x, lastPoint.y, (currentP.x + lastPoint.x) / 2, (currentP.y+ lastPoint.y) / 2);
            }
        }
        context.stroke();
    }
...
(function (scope) {
    ...
    InkGrabber.prototype.setPenOrErase = function (value) {
        this.penorerase = value;
        if (this.penorerase == 'pen') {
            this.penParameters.setColor('rgba(0, 0, 0, 255)');
